...
public class EditorGrafico extends JFrame {
    ...
    {   // título, estabelecerá um tamanho para o formulário e o exibirá
        ...
        botoes[4] = new LButton("circulo", 8, "Clique no centro do círculo.", "Desenhar um círculo");
        botoes[5] = new LButton("elipse", 9, "Clique em um dos vértices do retângulo que circunscreve a elipse.", "Desenhar uma elipse");
